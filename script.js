    ...
    item.innerHTML = `
                    ...
                    <div class="main_cart_slider_foto">
                            <div class="main_cart_slider_foto_container">
                                ...
                                <img src="image/slider_kedy2.png" alt="">
                                </div>
                            </div>
                            <div class="main_cart_slider_foto_container">
                                <div class="main_cart_slider_foto_1">
                                <img src="image/slider_obuv_1.png" alt="">
                                </div>
                            </div>
                            <div class="main_cart_slider_foto_container">
                                <div class="main_cart_slider_foto_1">
                                <img src="image/slider_muzhskiye-tufli.png" alt="">
                               </div>
                            </div>
                        </div>
                        <!-- Контейнер слайд-шоу -->
            ...
            this.innerHTML = `
                    <div class="main_cart_button_buy">
                       <div class="main_cart_button_buy_calc">
                         ...
                         <img src="image/spinner.svg" style="display: block; margin: 2px 0px 0px 42px;">
                         </div>
